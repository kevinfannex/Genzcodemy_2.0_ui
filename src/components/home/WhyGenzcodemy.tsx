        ...
        <div className="grid grid-cols-1 md:grid-cols-3 border-t border-white/10">
          {CARDS.map((card, i) => (
            <motion.div
              ...
              className={`group flex flex-col p-8 md:p-12 lg:p-14 border-b border-white/10 md:border-b-0 transition-all duration-300 ease-out hover:-translate-y-2 hover:bg-[#f5c518] hover:text-[#1a1a1a] hover:shadow-[0_15px_40px_rgba(245,197,24,0.3)] hover:z-20 ${card.isPrimary
